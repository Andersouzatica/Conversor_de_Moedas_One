...
public class Moeda {
	...
	public void reaisParaDolar(Double c) {
		...
		JOptionPane.showMessageDialog(null, "          Convertido R$ " + b + "\n        em US$ " + cot1 + " Dolares",
	...
	public void reaisParaEuro(Double c) {
		...
		JOptionPane.showMessageDialog(null, "          Convertido R$ " + g + "\n            em " + cot2 + " € Euros",
	...
	public void reaisParaPeso(Double c) {
		...
		JOptionPane.showMessageDialog(null, "       Convertido R$ " + f + " \n         em $ " + cot5 + " Peso",
	...
	public void dolaresParaReais(Double c) {
		...
		JOptionPane.showMessageDialog(null, "       Convertido US$ " + d + "\n          em R$ " + cot3 + " Reais",
	...
	public void euroParaReais(Double c) {
		...
		JOptionPane.showMessageDialog(null, "       Convertido " + e + " €\n       em R$ " + cot4 + " Reais",
				"Mensagem ao Usuário", JOptionPane.INFORMATION_MESSAGE, icon7);
	}
	...
	public void pesoParaReais(Double c) {
		...
		JOptionPane.showMessageDialog(null, "       Convertido $ " + h + " \n       em R$ " + cot6 + " Reais",
				"Mensagem ao Usuário", JOptionPane.INFORMATION_MESSAGE, icon7);
	}
